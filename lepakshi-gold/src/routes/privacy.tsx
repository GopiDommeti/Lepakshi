...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy policy — Lepakshi Gold" },
      {
        name: "description",
        content: "How Venkateshwara Oil Traders collects, uses and protects your data.",
      },
      { property: "og:title", content: "Privacy policy — Lepakshi Gold" },
      { property: "og:description", content: "Our data and privacy commitments." },
    ],
  }),
