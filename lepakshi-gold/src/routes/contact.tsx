  ...
  head: () => ({
    meta: [
      { title: "Contact & wholesale — Lepakshi Gold" },
      {
        name: "description",
        content:
          "Reach Venkateshwara Oil Traders for retail orders, wholesale supply and distributorship in Andhra Pradesh.",
      },
      { property: "og:title", content: "Contact & wholesale — Lepakshi Gold" },
      { property: "og:description", content: "Phone, WhatsApp, email and enquiry form." },
    ],
  }),
