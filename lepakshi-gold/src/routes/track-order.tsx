...
export const Route = createFileRoute("/track-order")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Enter your order number and phone to see where your oil is.",
      },
      { property: "og:title", content: "Track your order — Lepakshi Gold" },
      { property: "og:description", content: "Order status and courier tracking." },
    ],
  }),
  component: TrackPage,
});
