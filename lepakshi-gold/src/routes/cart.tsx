...
export const Route = createFileRoute("/cart")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review the oils in your cart before checking out." },
      { property: "og:title", content: "Your cart — Lepakshi Gold" },
      { property: "og:description", content: "Review your basket and head to checkout." },
