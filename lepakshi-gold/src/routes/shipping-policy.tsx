...
export const Route = createFileRoute("/shipping-policy")({
  head: () => ({
    meta: [
      { title: "Shipping policy — Lepakshi Gold" },
      { name: "description", content: "Dispatch times, delivery charges and tracking." },
      { property: "og:title", content: "Shipping policy — Lepakshi Gold" },
      { property: "og:description", content: "How and when your oil reaches you." },
    ],
  }),
  component: () => (
