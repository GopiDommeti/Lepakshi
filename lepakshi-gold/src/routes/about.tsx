...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "Our story — Venkateshwara Oil Traders since 2003" },
      {
        name: "description",
        content:
          "Three generations of patience, pressed into every bottle. How the wooden ganuga works and the standards we hold.",
      },
      { property: "og:title", content: "Our story — Lepakshi Gold" },
      {
        property: "og:description",
        content: "Venkateshwara Oil Traders, Andhra Pradesh, est. 2003.",
      },
    ],
  }),
  component: AboutPage,
...
const STANDARDS = [
  ...
  {
    title: "Pressing",
    body: "Only the ganuga. If a batch cannot be pressed the traditional way, we don't sell it as ganuga oil.",
  },
  {
    title: "Testing",
    ...
    <StoreLayout>
      ...
      <section className="mx-auto max-w-[1200px] px-6 py-14 sm:py-24">
        <div className="max-w-[68ch] space-y-6 text-ink-900">
          <p>
            Venkateshwara Oil Traders began in 2003 with one wooden ganuga and a simple, slightly
          ...
          <p>
            ...
            is easy to sell in volume. Ganuga oil is the opposite. Groundnut oil smells of
        ...
        <div className="max-w-[68ch] space-y-6 text-ink-900">
          ...
          <p>
            ...
            number of customers who order online and have it sent across the country. The ganuga
            is the same one.
          </p>
        </div>
      </section>
      ...
      <section className="bg-green-950 text-cream-50">
        <div className="mx-auto max-w-[1200px] px-6 py-16 sm:py-24">
          ...
          <h2 className="mt-3 font-display text-4xl">What is a ganuga?</h2>
