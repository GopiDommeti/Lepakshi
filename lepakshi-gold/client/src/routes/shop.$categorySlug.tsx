  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        {
          name: "description",
          content: `Cold-pressed ${label} oil in 500 ml to 15 L packs, pressed fresh in Andhra Pradesh.`,
        },
...
function Category() {
  ...
  return (
    <StoreLayout>
      {category ? (
        <Seo
          title={category.seo_title || `Organic ${category.name} — cold-pressed | Lepakshi Gold`}
          description={
            category.seo_description ||
            category.description ||
            `Shop organic ${category.name.toLowerCase()}, cold-pressed and unrefined, delivered across India.`
          }
