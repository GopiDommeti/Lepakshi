...
const PRODUCT_COLUMNS =
  "id,name,name_te,slug,type,category_id,short_description,description,thumbnail_url,gallery,gst_rate,is_organic,extraction,shelf_life,ingredients,storage,status,is_featured,sort_order,seo_title,seo_description,created_at,updated_at,sku_base,hsn_code,upsell_ids,crosssell_ids";
